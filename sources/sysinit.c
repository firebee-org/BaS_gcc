...
void init_gpio(void)
{
	 ...
	 * for DMA operation
	 */
	MCF_PAD_PAR_DMA = MCF_PAD_PAR_DMA_PAR_DACK0(MCF_PAD_PAR_DMA_PAR_DACK0_DACK0) |
			MCF_PAD_PAR_DMA_PAR_DACK1(MCF_PAD_PAR_DMA_PAR_DACK1_DACK1) |
			MCF_PAD_PAR_DMA_PAR_DREQ1(MCF_PAD_PAR_DMA_PAR_DREQ1_DREQ1) |
			MCF_PAD_PAR_DMA_PAR_DREQ0(MCF_PAD_PAR_DMA_PAR_DREQ0_DREQ0);
